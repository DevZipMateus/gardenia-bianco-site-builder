      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="max-w-4xl mx-auto text-center space-y-4 md:space-y-6">
          <div className="space-y-2 md:space-y-3">
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-primary-foreground tracking-tight animate-fade-in" style={{ animationDelay: '0.1s', animationFillMode: 'both', textShadow: '2px 2px 8px rgba(0, 0, 0, 0.8)', fontFamily: 'Bisney' }}>
              Gardênia Bianco RS
            </h1>
